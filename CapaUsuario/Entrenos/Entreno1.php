...
<div style="float:right">
				<li><a href="">Filtrar</a>
					<ul>
						<li><a href="..\Administracion\Mancuernas.php?Entreno=1">Mancuernas</a></li>
						<li><a href="..\Administracion\Plibre.php?Entreno=1">Peso libre</a></li>
						<!--<li><a <?php# header("Location: ..\Administracion\Mancuernas.php?Entreno=1");?> >Mancuernas</a></li>-->
					</ul>
				</li>					
			</div>					
		</ul>
			...
			<a href="#close" title="Close" class="close">X</a>		
				...
				<div class="formulario3">
					<div class="col-25">
						...
						<div class="col-75">	
							<input type="text" name="Repeticiones" placeholder="10x4/10KG"  required />
						</div>	
					</div>
				<br>
				<br>
