...
<div style="float:right">
				<li><a href="">Filtrar</a>
					<ul>
						<li><a href="..\Administracion\Mancuernas.php?Entreno=3">Mancuernas</a></li>
						<li><a href="..\Administracion\Plibre.php?Entreno=3">Peso libre</a></li>
					</ul>
				</li>					
			</div>				
		</ul>
	...
	<div id="Editar" class="modalDialog">
		<div>
			<a href="#close" title="Close" class="close">X</a>		
				...
				<br>
				<br>
					<button type="submit" name="Aceptar3" value="Aceptar3">Aceptar</button>	
				</div>
	</div>
	</form>
