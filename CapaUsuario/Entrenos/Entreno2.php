...
<div style="float:right">
			...
			<div style="float:right">
				<li><a href="">Filtrar</a>
					<ul>
						<li><a href="..\Administracion\Mancuernas.php?Entreno=2">Mancuernas</a></li>
						<li><a href="..\Administracion\Plibre.php?Entreno=2">Peso libre</a></li>
					</ul>
				</li>					
			</div>
		</ul>
	...
	<div id="Editar" class="modalDialog">
		<div>
			<a href="#close" title="Close" class="close">X</a>		
				...
				<br>
				<br>
					<button type="submit" name="Aceptar2" value="Aceptar2">Aceptar</button>	
				</div>
	</div>
	</form>
