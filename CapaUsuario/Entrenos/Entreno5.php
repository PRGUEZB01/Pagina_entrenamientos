...
<div style="float:right">
				<li><a href="">Filtrar</a>
					<ul>
						<li><a href="..\Administracion\Mancuernas.php?Entreno=5">Mancuernas</a></li>
						<li><a href="..\Administracion\Plibre.php?Entreno=5">Peso libre</a></li>
					</ul>
				</li>					
			</div>				
		</ul>
	...
	<div id="Editar" class="modalDialog">
		<div>
			<a href="#close" title="Close" class="close">X</a>		
				...
				<br>
				<br>
					<button type="submit" name="Aceptar5" value="Aceptar5">Aceptar</button>	
				</div>
	</div>
	</form>
