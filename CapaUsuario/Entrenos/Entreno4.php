...
<div style="float:right">
				<li><a href="">Filtrar</a>
					<ul>
						<li><a href="..\Administracion\Mancuernas.php?Entreno=4">Mancuernas</a></li>
						<li><a href="..\Administracion\Plibre.php?Entreno=4">Peso libre</a></li>
					</ul>
				</li>					
			</div>				
		</ul>
	...
	<div id="Editar" class="modalDialog">
		<div>
			<a href="#close" title="Close" class="close">X</a>		
				...
				<br>
				<br>
					<button type="submit" name="Aceptar4" value="Aceptar4">Aceptar</button>	
				</div>
	</div>
	</form>
